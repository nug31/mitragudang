...
app.get("/api/categories", async (req, res) => {
    try {
        // Auto-fix: Ensure ID is identity/auto-increment if it's not
        // This is safe to run multiple times as a check
        try {
            await db.query('ALTER TABLE categories ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY').catch(() => {});
        } catch (e) { /* ignore */ }
